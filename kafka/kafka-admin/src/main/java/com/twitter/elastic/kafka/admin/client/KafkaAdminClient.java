package com.twitter.elastic.kafka.admin.client;
...
import com.twitter.elastic.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    throws ExecutionException, InterruptedException {
        ...
        if (topics != null) {
            topics
                .forEach(topic -> LOG.debug("Topic with name {}", topic.name()));
        }
        return topics;
    }
